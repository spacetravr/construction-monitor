#!/usr/bin/env python3
"""
Step 7.1: Launch file to spawn ONE TurtleBot3 robot with namespace.
This is a TEST file - we test with ONE robot first before adding the second.

Robot1 topics will be:
- /robot1/cmd_vel
- /robot1/scan
- /robot1/odom
"""
...
def generate_launch_description():
    ...
    # Spawn robot1 in Gazebo at position (-2, -3)
    spawn_robot1 = Node(
        package='gazebo_ros',
